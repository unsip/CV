...
\begin{JobDescription}{C2C (Cmakify, GatewayFM)}{Jul 2023 --- Present}{Software Engineer}{Tbilisi}{2mm}
    ...
    \begin{itemize}
        ...
        \item Setting up \emph{ELK} for newly created environments
        \item \emph{AlertManager} configuration for catching critical application issues such as stale deployments, queues
            overflow, etc.
    \end{itemize}
\end{JobDescription}
...
\begin{JobDescription}{JettyCloud (RingCentral)}{Dec 2022 --- Apr 2023}{Release Engineer}{Tbilisi}{2mm}
    ...
    \begin{itemize}
        ...
        \item Traced and resolved issues occurred during QA regression cycles using \emph{ELK} and \emph{Zabbix}
...
\begin{JobDescription}{}{Apr 2022 --- Dec 2022}{Site Reliability Engineer}{Tbilisi}{-3mm}
    ...
    \item Traced and resolved service critical routing issues and telecommunication failures with further RCA using \emph{ELK}
...
\begin{JobDescription}{T-Systems (Deutsche Telekom)}{Jan 2020 --- Dec 2021}{Software Developer}{St. Petersburg}{0mm}
    ...
    \item Setting up monitoring with \emph{Grafana}, \emph{Prometheus} and \emph{ELK}
...
\begin{JobDescription}{}{Jul 2018 --- Jan 2020}{DevOps Engineer}{St. Petersburg}{-3mm}
    \item Configured \emph{Prometheus} and \emph{ELK} for project monitoring from scratch
