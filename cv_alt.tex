...
%Skills: Python, Gitlab CI, Jenkins, Puppet, ELK, Zabbix, Grafana, RHEL/Debian, k8s/Spinnaker, VMware
...
%Skills Python, Gitlab CI, Jenkins, Puppet, ELK, Zabbix, Grafana, RHEL/Debian, k8s/Spinnaker, AWS, VMware
...
%Skills: Python, C++(11/14/17), bash, RHEL, Make, Ninja, CMake, Gitlab CI, Jenkins
...
\end{JobDescription}
%Skills: Python, Django, Flask, ReactJS, RPyC, bash, Gitlab CI, k8s, Docker
...
\begin{JobDescription}{}{Jul 2018 --- Jan 2020}{DevOps Engineer}{St. Petersburg}{-3mm}
    ...
    \end{itemize}
\end{JobDescription}
% Skills: Python, Flask, ReactJS, RHEL/Debian, Ansible, Puppet/Bolt, ELK, Grafana, Prometheus, Docker, Vagrant, VirtualBox
